<?php //************** code PHP procédural classique ************** 
	...
	require('presentation/VCIMenu.vue.php');
      ...
      function AfficheDetailFilm($dataResa) {
          ?>
...
<form id="coordonnee" action="VCIResa4.php" method = "get">
	<input type = "hidden" name="codfil" value="<?php  echo $dataResa['filmchoisi'] ; ?>">
	<input type="hidden" name ="libfil" value="<?php  echo $dataResa['libfilmchoisi'] ;?>">
	<h1 >Voici le film que vous avez sélectionné</h1>
	<div class="centrer cent">
	<table class="recap"> 
		<tr>
			<td rowspan="3"><img src="presentation/images/affiches/<?php  echo $dataResa['affiche'] ;?>" /></td>
			<td>titre :</td>
			<th><?php  echo $dataResa['libfilmchoisi']; ?></th>
			</tr>
		<tr>
			<td>année :</td>
			<th><?php  echo $dataResa['anfilmchoisi']; ?></th>
		</tr>
		<tr>
			<td>réalisateur :</td>
			<th><?php  echo $dataResa['reafilmchoisi']; ?></th>
		</tr>
	</table>
